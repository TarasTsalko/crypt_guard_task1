...
{
    char* args[] = {"CryptGuard","-i", "input.txt", "--command", "encrypt_2" , "-o", "output.txt", "-p", "123", nullptr };
    const int argc = 9;
    CryptoGuard::ProgramOptions options;
    const bool res =  options.Parse(  argc, args );
    EXPECT_FALSE( res );
...
{
    char* args[] = {"CryptGuard","--input", "input.txt", "--output", "output.txt", "--command", "encrypt" , "--password", "123" };
    const int argc = 9;
    CryptoGuard::ProgramOptions options;
    const bool res = options.Parse(  argc, args );
    EXPECT_TRUE( res );
...
{
    char* args[] = {"CryptGuard","--input", "input.txt", "--output", "output.txt", "--command", "decrypt" , "--password", "123" };
    const int argc = 9;
    CryptoGuard::ProgramOptions options;
    const bool res = options.Parse(  argc, args );
    EXPECT_TRUE( res );
